...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div style="font-size: 1.1rem; font-weight: bold;" class="card-header text-center">{{ __('Confirmar Palavra-Passe') }}</div>

                <div class="card-body">
                    {{ __('Confirme a sua Palavra-Passe antes de proseeguir.') }}
